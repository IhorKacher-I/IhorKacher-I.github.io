...
class Visit {
  ...
  renderShortCard() {
    ...
    card.innerHTML = `
			 <div class="card__info" id="${this.id}>
				<h4 class="card__name">
					${this.patientName}
				</h4>
    ...
    btnMore.addEventListener("click", () => {
      ...
      modalFullInfo.style.display = "block";
      ...
      modalFullInfo.innerHTML = `<div class="cards__full-visit-information">
					 ...
					 <div class="full-visit-information__body">
						 ...
						 <div class="full-visit-information__visit-description">
							 ...
							 <span class="visit-description__value"> ${this.description}</span>
						 </div>
      ...
      const closeBtn = modalFullInfo.querySelector(".header__close-button");
      closeBtn.addEventListener(
        "click",
        () => (modalFullInfo.style.display = "none")
      );
    });
