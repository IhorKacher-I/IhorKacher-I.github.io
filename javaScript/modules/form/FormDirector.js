...
export default class FormDirector {
  ...
  buildCreateVisitForm() {
    ...
    this.#builder.addTextarea(
      ["create-visit__description"],
      "text",
      true,
      "Description"
    );
  ...
  addCardiologistFields() {
    return [
      createHTMLElement(
        "input",
        ["create-visit__pressure", "additional-fields"],
        { type: "text", placeholder: "Normal pressure:" }
      ),
      ...
      createHTMLElement(
        "textarea",
        ["create-visit__diseases", "additional-fields"],
  ...
  addDentistFields() {
    return createHTMLElement(
      "input",
      ["create-visit__last-visit", "additional-fields"],
      { type: "date", placeholder: "Date of last visit:" }
    );
  }
  addTherapistFields() {
    return createHTMLElement(
      "input",
      ["create-visit__therapist-age-field", "additional-fields"],
